...
export const GRID_ITEMS: GridItemConfig[] = [
  ...
  { col: 5,  row: 5, colSpan: 1, rowSpan: 1, label: "BlackHole",    href: "#", hoverText: "singularity",                             favicon: "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24'%3E%3Ccircle cx='12' cy='12' r='10' fill='%23000'/%3E%3C/svg%3E" },
]
